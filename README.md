...
Here we can see a well-designed website, divided for the most part by sections and articles, its hierarchy is well distributed since its titles are seen in a larger size. 

In addition to this we can see the images well distributed, since depending on whether we look at the page from a PC, cell phone or tablet, they can be seen either at the top or bottom of the text without interfering with the page.
